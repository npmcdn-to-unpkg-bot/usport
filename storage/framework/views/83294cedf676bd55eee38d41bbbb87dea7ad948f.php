...
<div class="container">
    ...
    <!-- <div class="control-group <?php echo $errors->has('type') ? 'error' : ''; ?>">
        ...
        <div class="controls">
            <?php echo Form::select('type', array('text'=>'Text', 'image'=>'Image', 'video'=>'Video'), $post->type, array('class' => 'form-control', 'value'=>Input::old('type'))); ?>
    ...
    <!-- <div class="control-group <?php echo $errors->has('category_id') ? 'error' : ''; ?>">
        ...
        <div class="controls">
            <?php echo Form::select('category_id', $categories, $post->category_id, array('class' => 'form-control', 'value'=>Input::old('category_id'))); ?>
    ...
    <div class="control-group <?php echo $errors->has('content') ? 'has-error' : ''; ?>">
        ...
        <div class="controls">
            <?php echo Form::textarea('content', $post->content, array('class'=>'form-control', 'id' => 'content', 'placeholder'=>'Input a caption', 'value'=>Input::old('content'))); ?>
    ...
    <div class="control-group <?php echo $errors->has('src') ? 'has-error' : ''; ?>">
        ...
        <div class="controls">
            <?php echo Form::text('src', $attachments->src, array('class'=>'form-control', 'id' => 'src', 'placeholder'=>'Http://', 'value'=>Input::old('src'))); ?>
    ...
    <!-- <div class="control-group <?php echo $errors->has('source') ? 'has-error' : ''; ?>">
        ...
        <div class="controls">
            <?php echo Form::text('source', $post->source, array('class'=>'form-control', 'id' => 'source', 'placeholder'=>'Sưu tầm', 'value'=>Input::old('source'))); ?>
